...
function addMessage(role, content) {
  ...
  // Performance optimization: Using textContent instead of innerHTML to avoid HTML parsing
  // and using a sub-element with pre-wrap for proper formatting
...
function addProcessingMessage() {
  ...
  // Performance optimization: Avoid innerHTML by creating elements directly
...
async function loadAgentStatuses() {
  try {
    ...
    // Performance optimization: Using DocumentFragment to batch DOM updates
